...
### 📰 AI 新闻早报（每日 07:00）
**代号**：AI-NEWS-ROUNDUP
**版本**：v2.0.0（2026-07-12 升级）
**触发**：每日 07:00 (Asia/Taipei)
**执行体**：cron `e69da437` → isolated agentTurn `agentId: main`，600s timeout
**架构**：bash 脚本层（fetch + build）→ Agent 策展层（选文/标题重写/标签/寄语/产品甄别）→ 格式化 + Vercel 部署 → 飞书推送
**推送**：飞书 user:ou_f804aeb5aa82fc47dca4830476a6e75d
**状态**: ✅ **NEW** — 2026-07-12 23:01 重建：v2.0.0 架构，Agent 接管策展，清理重复 cron。

---
*最后更新: 2026-07-12 23:01*
